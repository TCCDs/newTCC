$(function() {
    ...
    $('input[name=next2]').click(function() {
        var array = formulario.serializeArray();
        if (array[3].value == '' || array[4].value == '' || array[5].value == '' || array[6].value == '' || array[7].value == '' || array[8].value == '' || array[9].value == '' || array[10].value == '' || array[11].value == '' || array[12].value == '') {
    ...
    $('input[name-btn-add]').click(function(evento) {
        var array = formulario.serializeArray();
        if (array[13].value == '' || array[14].value == '' || array[15].value == '' || array[16].value == '' || array[17].value == '' || array[18].value == '' || array[19].value == '' || array[20].value == '') {
