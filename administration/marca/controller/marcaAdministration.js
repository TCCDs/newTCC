                        ...
                        <div class="card" style="width: 20em;  height: 47rem;">
                            <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item"><button id="` + dados[i].ID_MARCA + `" class="btn  btn-block btn-primary btn-sm btn-view-adm"> <i class="mdi mdi-eye mdi-18px "></i> </button>
                                        </li>
                                        <li class="list-group-item"> <button id="` + dados[i].ID_MARCA + `" class="btn btn-block btn-warning btn-sm btn-edit-adm"> <i class="mdi mdi-pencil mdi-18px"></i> </button>
                                        </li>
