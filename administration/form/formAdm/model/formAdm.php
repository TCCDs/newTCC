...
if(isset($_POST["NOME_ADMINISTRADOR"])) {
    ...
    try {
        $sql = "INSERT INTO ADMINISTRADOR (ID_USUARIOS, NOME_ADMINISTRADOR, RG_ADMINISTRADOR, CPF_ADMINISTRADOR, SEXO_ADMINISTRADOR, DATA_NASCIMENTO_ADMINISTRADOR, EMAIL_ADMINISTRADOR, CELULAR_ADMINISTRADOR, CEP_ADMINISTRADOR, CIDADE_ADMINISTRADOR, ESTADO_ADMINISTRADOR, ENDERECO_ADMINISTRADOR, NUMERO_ADMINISTRADOR, BAIRRO_ADMINISTRADOR, NACIONALIDADE_ADMINISTRADOR, COMPLEMENTO_ADMINISTRADOR)
                VALUES (:ID_USUARIOS, :NOME_ADMINISTRADOR, :RG_ADMINISTRADOR, :CPF_ADMINISTRADOR, :SEXO_ADMINISTRADOR, :DATA_NASCIMENTO_ADMINISTRADOR, :EMAIL_ADMINISTRADOR, :CELULAR_ADMINISTRADOR, :CEP_ADMINISTRADOR, :CIDADE_ADMINISTRADOR, :ESTADO_ADMINISTRADOR, :ENDERECO_ADMINISTRADOR, :NUMERO_ADMINISTRADOR, :BAIRRO_ADMINISTRADOR, :NACIONALIDADE_ADMINISTRADOR, :COMPLEMENTO_ADMINISTRADOR)
    ";
