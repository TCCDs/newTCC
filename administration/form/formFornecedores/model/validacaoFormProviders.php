<?php
    ...
    if ($requestData):
        ...
        elseif ((strlen($resultDados['RAZAO_SOCIAL_FORNECEDORES'])) <= 5):
            $erro = true;
            $mensagem = "RAZÃO SOCIAL FORNECEDORES deve ter no minímo 5";
        ...
        elseif ((!isset ($resultDados['EMAIL_FORNECEDORES']) || !filter_var($resultDados['EMAIL_FORNECEDORES'], FILTER_VALIDATE_EMAIL)) && !$erro):
            $erro = true;
            $mensagem = "O campo EMAIL FORNECEDORES precisa de um endereço válido";
        ...
        elseif (!preg_match("#[a-z]+#", $resultDados['ENDERECO_FORNECEDORES'])):
            $erro = true;
            $mensagem = "O campo ENDEREÇO FORNECEDORES precisa de pelo menos uma letra minúscula";
        ...
        elseif ((strlen($resultDados['ENDERECO_FORNECEDORES'])) <= 5):
            $erro = true;
            $mensagem = "ENDEREÇO FORNECEDORES deve ter no minímo 5";
        ...
        elseif(!is_numeric($resultDados['NUMERO_FORNECEDORES'])):
            $erro = true;
            $mensagem = "NÚMERO FORNECEDORES somente números";
