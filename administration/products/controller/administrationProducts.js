$(document).ready(function() {
    ...
    $.ajax({
        ...
        success: function(dados) {
            for (var i = 0; i < dados.length; i++) {
                ...
                <tr>
                    ...
                    <td class="text-center" width="15%">
                        ...
                        <button id="` + dados[i].ID_PRODUTOS + `" class="btn btn-outline-warning btn-sm btn-edit"> <i class="mdi mdi-pencil mdi-18px"></i> </button>
                        <button id="` + dados[i].ID_PRODUTOS + `" class="btn btn-outline-danger btn-sm btn-delete"> <i class="mdi mdi-delete mdi-18px"></i> </button>
                    </td>
                </tr>
                `
            ...
            $('body').append('<script>$(".zz").click(function(){ $("#conteudo").load("administration/form/formProdutos/view/formProducts.html")})</script>')
