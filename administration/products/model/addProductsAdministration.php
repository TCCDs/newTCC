<?php
    ...
    if ($NOME_PRODUTOS != "" &&  $PRECO_VENDA_PRODUTOS != "") {
        ...
        $sql = "INSERT INTO produtos (NOME_PRODUTOS,  PRECO_CUSTO_PRODUTOS, PRECO_VENDA_PRODUTOS, VALIDADE_PRODUTOS, PESO_PRODUTOS, DESCRICAO_PRODUTOS, QR_CODE_PRODUTOS, ESTOQUE_PRODUTOS, CATEGORIAS_PRODUTOS, CORREDOR_PRODUTOS, PRATILEIRA_PRODUTOS, LOTE_PRODUTOS)
        VALUES ('".$NOME_PRODUTOS."', '".$PRECO_CUSTO_PRODUTOS."','".$PRECO_VENDA_PRODUTOS."', '".$VALIDADE_PRODUTOS."', '".$PESO_PRODUTOS."', '".$DESCRICAO_PRODUTOS."', '".$QR_CODE_PRODUTOS."', '".$ESTOQUE_PRODUTOS."', '".$CATEGORIAS_PRODUTOS."', '".$CORREDOR_PRODUTOS."', '".$PRATILEIRA_PRODUTOS."', '".$LOTE_PRODUTOS."')";
