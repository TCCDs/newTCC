...
-- Copiando dados para a tabela new_supermercado.cliente_pagamentos: ~35 rows (aproximadamente)
...
-- Copiando dados para a tabela new_supermercado.compras: ~30 rows (aproximadamente)
...
-- Copiando dados para a tabela new_supermercado.compras_itens: ~39 rows (aproximadamente)
...
-- Copiando dados para a tabela new_supermercado.compras_pagamentos: ~6 rows (aproximadamente)
...
-- Copiando dados para a tabela new_supermercado.moedas: ~36 rows (aproximadamente)
...
-- Copiando estrutura para tabela new_supermercado.receita
...
-- Copiando dados para a tabela new_supermercado.receita: ~2 rows (aproximadamente)
...
-- Copiando estrutura para tabela new_supermercado.receita_categoria
...
-- Copiando dados para a tabela new_supermercado.receita_categoria: ~1 rows (aproximadamente)
